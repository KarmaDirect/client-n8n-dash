...
-- RLS Policy pour la vue (admins uniquement)
DROP POLICY IF EXISTS support_unread_counts_select ON public.support_unread_counts;
-- Note: Les vues avec RLS nécessitent une politique sur la table sous-jacente
-- Les admins peuvent déjà voir tous les messages via admin_select_all_support_messages
